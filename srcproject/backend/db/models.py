...
class User(Base):
    ...
    folder = relationship('Folder', back_populates='users', cascade="all, delete-orphan")
...
class Folder(Base):
    ...
    note = relationship('Note', back_populates='folder', cascade="all, delete-orphan")
...
class Note(Base):
    ...
    flashcard = relationship('Flashcard', back_populates='note', cascade="all, delete-orphan")
